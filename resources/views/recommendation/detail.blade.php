    ...
    <div class="container d-flex justify-content-center my-5 border p-5" style="background-color : 	rgb(248, 191, 85);">
        <div class="row my-2 mx-2 main">
            <div class="d-flex flex-row">
                <div class="mr-5">
                    <img src="{{ $food->image }}" width="300px" height="300px">
                </div>
                <div class="ml-5">
                    <h3>{{ $food->name }}</h3>
                    <br>
                    ...
                    <div class="col-md-8 col-12 xcol">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <a class="btn btn-warning btn-primary mt-4 mb-5"
                                    style="background-color : 	rgb(255, 167, 2);" href="/food" type="submit">Back</a>
                            </div>
                        </div>
                    </div>
